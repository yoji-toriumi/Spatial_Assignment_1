...
This map shows schools as smaller points to pinpoint their location, then adds wider circles to (very roughly) estimate a short walking 5 minute distance. This map does not distinguish between owners of open space in Cambridge.
