...
<h1>Map-1 - Cambridge Schools and Open Space<h1/>
...
<h1>Map-2 - Too Dark, Not Working<h1/>
Like prior images, this map also shows private and public schools in Cambridge and their relationship to open space. However, by using such a dark basemap with grey polygons, it can be difficult to distinguish one data point from another.
...
<h1>Map-3 - Clear Communication, Cambridge Schools and Open Space<h1/>
...
<h1>Map-4 - Quarter-Mile Distance to Open Space from Cambridge Schools<h1/>
...
<h1>Map-5 -  Cambridge Schools' Proximity to Open Space<h1/>
This map shows schools as smaller points to pinpoint their location, then adds wider circles to (very roughly) estimate a short 5 minute walking distance. This map does not distinguish between owners of open space in Cambridge.
