...
ggplot()+
  ...
  geom_sf(data = pubschool, size = 3, aes(color = "Public"), alpha = 1/2) +
  geom_sf(data = prischool, size = 3, aes(color = "Private"), alpha = 1/2) +
  scale_color_manual(values = c("Public" = "seagreen1", "Private" = "tomato"), name = "School") +
  theme_void()
```
